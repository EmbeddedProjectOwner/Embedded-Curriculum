...
A Document tree is essentially a hierarchy, similar to an ancestor tree.

- Parent: A parent in HTML, is an element that is the 'container' or holder of another element. 
```tsx
<ul> // [!code highlight]
    <li></li>
</ul>
