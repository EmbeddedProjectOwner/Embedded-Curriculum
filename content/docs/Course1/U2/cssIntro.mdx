...
<DocComponents.Steps.Steps>
    ...
    <DocComponents.Steps.Step>
        ...
        **Usage:** To use external CSS, you'll need to 'import' the stylesheet. First you'll need to make sure that your CSS is in a dedicated `.css` file, then this by add the `<link></link>{:html}` element in the `<head>{:html}` of the HTML, and editing/adding these two properties:<br/><br/>
        ...
        **Example:**
        ...
        <CodeBlockOutput className="m-[2%]">
                    <Tabs items={["HTML", "CSS File"]} defaultValue="HTML" >
                        ...
                        <html>
                            <head>
                                ...
                                <link rel="stylesheet" href="../../../../app/css/index.css"></link>
                            </head>
                            <body>
                                <p>My Text Color is Green!</p>
                            </body>
